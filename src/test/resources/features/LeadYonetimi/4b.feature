...
#    And OTP dogrulamasi kapatilir
  ...
  Scenario Outline: 4b5 - Gelen SMS onayLI, isim farkli, kulup farkli, mevcut SMS onayLI, atali, telefon gorevi var
    ...
    Examples:
      | ad  | soyad | gsmNo      | email                   | kaynak       | dogumTarihi | portalUrl            | portalAd | portalSoyad | sehir    | portalKulup           | portalDogumTarihi | expectedAd | expectedSoyad | expectedKulup  | expectedSatisTemsilcisi | expectedTags   | gorevTipi              | nedenKodu           |
      | Ela | kulta | 5981110515 | testlead4b5@hotmail.com | Kulube gelen | 01.01.1990  | dijital-uyelik-formu | Katalon  | Automation  | İstanbul | MACFit Flatofis Haliç | 18.09.2000        | Katalon    | Automation    | Flatofis Haliç | System                  | Steps: Success | Telefon Aramasi Planla | Alotech Ulasilamadi |
  ...
  Scenario Outline: 4b6 - Gelen SMS onayLI, isim farkli, kulup farkli, mevcut SMS onaysiz, atali, randevu/tur gorevi var
    ...
    Examples:
      | ad  | soyad | gsmNo      | email                   | kaynak       | dogumTarihi | portalUrl           | portalAd | portalSoyad | sehir    | portalKulup           | portalDogumTarihi | expectedAd | expectedSoyad | expectedKulup | expectedSatisTemsilcisi | expectedTags       | gorevTipi      | nedenKodu         |
      | Ela | kulta | 5981110516 | testlead4b6@hotmail.com | Kulube gelen | 01.01.1990  | vucut-analizi-formu | Katalon  | Automation  | İstanbul | MACFit Flatofis Haliç | 18.09.2000        | Katalon    | Automation    | 42 Maslak     | System                  | Steps: Information | Randevu Planla | Randevu Ayarlandı |
  ...
  Scenario Outline: 4b7 - Gelen SMS onayLI, isim farkli, kulup farkli, mevcut SMS onayLI, atali, randevu/tur gorevi var - kuluba dokunma
    ...
    Examples:
      | ad  | soyad | gsmNo      | email                   | kaynak       | dogumTarihi | portalUrl            | portalAd | portalSoyad | sehir    | portalKulup           | portalDogumTarihi | expectedAd | expectedSoyad | expectedKulup | expectedSatisTemsilcisi | expectedTags   | gorevTipi      | nedenKodu         |
      | Ela | kulta | 5981110517 | testlead4b7@hotmail.com | Kulube gelen | 01.01.1990  | dijital-uyelik-formu | Katalon  | Automation  | İstanbul | MACFit Flatofis Haliç | 18.09.2000        | Katalon    | Automation    | 42 Maslak     | System                  | Steps: Success | Randevu Planla | Randevu Ayarlandı |
  ...
  Scenario Outline: 4b9 - Gelen SMS onayLI, isim farkli, kulup farkli, mevcut SMS onayLI, atali, ret/satis/uzerine alma gorevi var
    ...
    Examples:
      | ad  | soyad | gsmNo      | email                   | kaynak       | dogumTarihi | portalUrl            | portalAd | portalSoyad | sehir    | portalKulup           | portalDogumTarihi | expectedAd | expectedSoyad | expectedKulup | expectedSatisTemsilcisi | expectedTags   | gorevTipi       | nedenKodu           |
      | Ela | kulta | 5981110519 | testlead4b9@hotmail.com | Kulube gelen | 01.01.1990  | dijital-uyelik-formu | Katalon  | Automation  | İstanbul | MACFit Flatofis Haliç | 18.09.2000        | Katalon    | Automation    | 42 Maslak     | System                  | Steps: Success | Satış Görüşmesi | Alotech Ulasilamadi |
  ...
  Scenario Outline: 4b10 - Gelen SMS onayLI, isim farkli, kulup farkli, mevcut SMS onayLI, atali, gorev yok
    ...
    Examples:
      ...
      | Ela | kulta | 5981110520 | testlead4b10@hotmail.com | Kulube gelen | 01.01.1990  | vucut-analizi-formu | Katalon  | Automation  | İstanbul | MACFit Flatofis Haliç | 18.09.2000        | Katalon    | Automation    | 42 Maslak     | System                  | Steps: Success |
