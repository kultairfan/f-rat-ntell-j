...
Feature: Lead Portal Akisi - Olympus Aday Uye + Portal 2. Gidis
  ...
  Scenario Outline: 1A2 - Aday uye olustur Otp li joinus 2. gidis OTPsiz
    ...
    Examples:
      ...
      | Ela | kulta | 5981110516 | testfirat1@hotmail.com | Kulube gelen | 01.01.1990  | join-us   | Ela | kulta       | İstanbul | MACFit 42 Maslak | Afghanistan | 18.09.2000        | 5941412    | Fişekhane     | System                  | Adım: Kişisel Bilgi | Tur Olustur | Alotech Ulasilamadi |
